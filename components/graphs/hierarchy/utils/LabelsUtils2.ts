...
function getTextElementsPositions(svg: Selection<SVGSVGElement, unknown, null, undefined>): TextElementPosition[] {
...
function isColliding(elem1: SVGTextElement, elem2: SVGTextElement): boolean {
  ...
  function hideLongerTextOnCollision(textElements: SVGTextElement[]): void {
